...
const ARCHETYPES: Array<{ noun: string; emoji: string; color: string }> = [
...
export function avatarFor(sessionId: string): Avatar {
...
export function nameFor(sessionId: string, displayName?: string): string {
...
export function islandNameFor(projectPath: string): string {
